        ...
        <CardContent>
          <form>
              ...
              <div className='form-component category-field'>
                <TextField required id="outlined-required" label="Product" sx={{width:300}} value={name} 
                onChange={(e)=>setName(e.target.value)} error={errorName} helperText={errorName===true?"Missing entry":""}/>
              </div>
              <div className='form-component product-field'>
                <TextField required id="outlined-required" label="Category" sx={{width:300}} value={category} 
                onChange={(e)=>setCategory(e.target.value)} error={errorCategory} helperText={errorCategory===true?"Missing entry":""}/>
              </div>
              <div className='form-component price-field'>
                <TextField required id="outlined-required" label="Price" sx={{width:300}}  value={price} 
                onChange={(e)=>setPrice(e.target.value)} error={errorPrice} helperText={errorPrice===true?"Invalid entry. Price should be a number":""}/>
              </div>
